        ...
        <Wrapper className="bg-[url('/about-background.png')] bg-top bg-cover bg-no-repeat">
            <section className="relative py-16 overflow-hidden mx-auto w-full lg:w-[90%]">
                <div className="relative z-10 container mx-auto">
                    <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-8 xl:gap-0 max-w-7xl mx-auto md:px-6 lg:px-0">
                        {/* Image */}
                        <div className="w-screen mx-auto relative sm:left-[5%] md:left-[12.5%] lg:left-0 lg:w-[50%] xl:w-[46%]">
                            <Image
                        ...
                        {/* Content */}
                        <div className="w-full lg:w-[45%] xl:w-[54%] space-y-5">
                            <h2 className="text-3xl lg:text-4xl font-bold text-[#0C73B5]">About Us</h2>

                            <div className="flex flex-col gap-3 lg:gap-6 lg:w-[65%]">
                                <p className="text-[#58595B] leading-tight text-xs sm:text-lg lg:text-sm xl:text-[19px]">
