                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                            ...
                            <div className="space-y-12">
                                {/* Contact Info */}
                                <div className="flex flex-wrap items-center gap-4 md:gap-6 text-white text-xs md:text-lg">
                                ...
                                {/* Company Info */}
                                <div className="text-white/80 text-xs md:text-[16px] space-y-1">
                            ...
                            <div className="text-white items-end text-xs md:text-[17px] text-left md:text-left">
