...
export function RegisterSection() {
    ...
    return (
        <section id="register" className="bg-[#f8fbfd] py-16 md:py-20">
                ...
                <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <Input
                            ...
                            className="bg-white border-[#d1e3f0] rounded-lg h-12 text-sm placeholder:text-[#9cb3c9]"
                        />
                        <Input
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <Select onValueChange={(value) => setFormData({ ...formData, location: value })}>
                            <SelectTrigger className="bg-white border-[#d1e3f0] rounded-lg h-12 text-sm text-[#9cb3c9] data-[state=open]:text-[#1a365d]">
                    ...
                    <div className="text-center">
                        <Button
                            type="submit"
                            className="bg-[#ED1C24] hover:bg-[#c91920] text-white px-10 md:px-14 py-5 md:py-6 text-base md:text-lg rounded-full font-semibold shadow-lg hover:shadow-xl transition-all"
                        >
                            SIGN UP
                        </Button>
                    </div>
